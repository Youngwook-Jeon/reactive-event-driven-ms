...
public class KafkaProcessorTests extends AbstractIntegrationTests {

    private static final Logger log = LoggerFactory.getLogger(KafkaProcessorTests.class);
    ...
    public void processorTest() {
        ...
        resSink.asFlux()
                ...
                .consumeNextWith(m -> Assertions.assertEquals("YOUNG", m))
                .consumeNextWith(m -> Assertions.assertEquals("LUCAS", m))
                .verifyComplete();
    }
